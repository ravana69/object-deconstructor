...
async function Draw(){
  ...
  if(!t){
    ...
    base_shps = []
    base_shps = [...base_shps, await loadOBJ('https://srmcgann.github.io/objs/goodcar3.obj', 6, 0,4,0,0,0,Math.PI/2)]
    base_shps = [...base_shps, await loadOBJ('https://srmcgann.github.io/objs/tree3.obj', 3, 0,2,0,0,0,0)]
    base_shps = [...base_shps, await loadOBJ('https://srmcgann.github.io/objs/axe.obj', 70, 0,10,0,0,0,0)]
    base_shps = [...base_shps, await loadOBJ('https://srmcgann.github.io/objs/pickaxe.obj', 80, 0,10,0,0,0,0)]
    base_shps = [...base_shps, await loadOBJ('https://srmcgann.github.io/objs/hand.obj', .5, 0,5,0,0,0,0)]
    base_shps = [...base_shps, await loadOBJ('https://srmcgann.github.io/objs/tree2.obj', .1, 0,10,0,0,0,Math.PI/2)]
    base_shps = [...base_shps, await loadOBJ('https://srmcgann.github.io/objs/chair.obj', 30, 0,10,0,0,0,0)]
    base_shps = [...base_shps, await loadOBJ('https://srmcgann.github.io/objs/rock.obj', 10, 0,8,0,0,0,0)]
    base_shps = [...base_shps, await loadOBJ('https://srmcgann.github.io/objs/heart.obj', .5, 0,10,0,0,0,0)]
    base_shps = [...base_shps, await loadOBJ('https://srmcgann.github.io/objs/glasses.obj', .4, 0,3,0,0,0,0)]
    base_shps = [...base_shps, await loadOBJ('https://srmcgann.github.io/objs/sea_turtle.obj', 3, 0,0,0,0,0,0)]
    base_shps = [...base_shps, await loadOBJ('https://srmcgann.github.io/objs/fish.obj', 5, 0,3,0,0,0,0)]
    base_shps = [...base_shps, await loadOBJ('https://srmcgann.github.io/objs/cat.obj', .75, 0,10,0,0,0,0)]
    base_shps = [...base_shps, await loadOBJ('https://srmcgann.github.io/objs/elephant.obj', 3, 0,15,0,0,0,0)]
    base_shps = [...base_shps, await loadOBJ('https://srmcgann.github.io/objs/car.obj', 3, 0,4,-3,0,0,0)]
    base_shps = [...base_shps, await loadOBJ('https://srmcgann.github.io/objs/WoodHouse.obj', 6, 0,5,0,0,0,0)]
    base_shps = [...base_shps, await loadOBJ('https://srmcgann.github.io/objs/t-rex.obj', .3, 0,10,2,0,0,0)]
    base_shps = [...base_shps, await loadOBJ('https://srmcgann.github.io/objs/skull_lowpoly.obj', 3, 0,10,0,0,0,0)]
    base_shps = [...base_shps, await loadOBJ('https://srmcgann.github.io/objs/hat.obj', 6, 0,0,0,0,0,0)]
    base_shps = [...base_shps, await loadOBJ('https://srmcgann.github.io/objs/M9.obj', 2, 0,0,0,0,0,0)]
    base_shps = [...base_shps, await loadOBJ('https://srmcgann.github.io/objs/rose.obj', .3, 0,10,0,0,0,0)]
    base_shps = [...base_shps, await loadOBJ('https://srmcgann.github.io/objs/skull3.obj', 1, 0,10,0,0,0,0)]
    base_shps = [...base_shps, await loadOBJ('https://srmcgann.github.io/objs/robotic_arm.obj', .6, 0,10,0,0,0,0)]
    base_shps = [...base_shps, await loadOBJ('https://srmcgann.github.io/objs/wolf.obj', .03, 0,10,0,0,0,0)]
    base_shps = [...base_shps, await loadOBJ('https://srmcgann.github.io/objs/ladybug.obj', 4500, 0,5,0,0,0,0)]
    base_shps = [...base_shps, await loadOBJ('https://srmcgann.github.io/objs/tiger.obj', .025, 0,10,0,0,0,0)]
    ...
    spawnShp = () => {
      ...
      if(Rn()<.1){
        switch(Rn()*5|0){
          ...
          ls_ = ls * 1
          shpsel++// = (base_shps.length*Rn())|0
          if(shpsel>base_shps.length-1) shpsel=0
          showlinesAr = [1,2,3,7,8,11]
          if(showlinesAr.indexOf(shpsel)!==-1) showlines = true
          newShp = JSON.parse(JSON.stringify(base_shps[shpsel]))
      }
      vx = S(t*8) * iShpv*5
      vy = -1.5
      vz = C(t*8) * iShpv*5
      ...
      shps = [...shps, [tx, ty, tz, newShp, 1, vx, vy, vz, irl, ipt, iyw, rl, pt, yw, showlines]]
    }
  ...
  oX=0, oY=3, oZ=Math.min(110, Math.max(60,(.3+S(t/2))*250))
  Rl=C(t/2)/8, Pt=-.5+C(t/2)/2, Yw=Math.PI/2+S(t/2)
  ...
  sparks.map(v=>{
    ...
    if(Z>0){
      l = Q()
      s = Math.min(1e3, 20000/Z*v[6]*v[7])
  ...
  shps.map(v => {
    ...
    v[3].map(q => {
      ...
      if(ay + ty > floor_base) {
        if(!q[13]){
          if(d__ < G/1.1){
            if(Rn()<.2)spawnSparks(ax+tx, ay+ty, az+tz, v[4])
            q[14] += 50
            q[4] += v[5]*.75
            q[5] *= q[5] > 0 ? -.75 : 1
            q[6] += v[7]*.75
      ...
      q[0].map(n=>{
        ...
        if(q[13]){
          ...
          if(ay+ty > floor_base){
            d__ = Math.hypot(ax+tx, az+tz)
            if(d__ < G/1.1 && ay+ty <floor_base+5){
              if(Rn()<.015)spawnSparks(tx + ax, floor_base, tz + az, v[4])
              q[4] *= .99
              q[6] *= .99
            }
          }
      ...
      flash = q[14] /= 1.1
      col1 = v[14] ? `hsla(${t*50},99%,${70 + flash**2}%,${v[4]**.5*(2+flash/8)})` : ''
      col2 = `hsla(${t*50},99%,${50 + flash**2}%,${v[4]**.5*.4*(1+flash/15)})`
      if(maxd<.03) stroke(col1, col2, 4, false)
    })
  })
